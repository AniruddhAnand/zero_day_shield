  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          CupertinoButton(
            child: Icon(Icons.bank, color: Colors.black),
            onPressed: () async {
            ...
            child: Column(
              children: <Widget>[
                    ...
                    Column(
                      ...
                      children: <Widget>[
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            color: Colors.black,
                            fontSize: MediaQuery.of(context).size.width<375?12:15,
                          ),
                        ),
                      ],
                    ),
                ...
                Row(
                  ...
                  children: <Widget>[
                    Text(
                      ...
                      style: TextStyle(
                        color: Colors.black,
                        fontSize: MediaQuery.of(context).size.width<375?17:20,
                      ),
                    ),
                    Row(
                      children: [
                        IconButton(
                          iconSize: MediaQuery.of(context).size.width<375?15:24,
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            color: Colors.black,
                            fontSize: MediaQuery.of(context).size.width<375?15:20,
                          ),
                        ),
                        IconButton(
                          iconSize: MediaQuery.of(context).size.width<375?15:24,
                ...
                Row(
                  ...
                  children: [
                    CupertinoButton(
                      padding: MediaQuery.of(context).size.width<375?EdgeInsets.only(left:45,right:45):CupertinoButton(onPressed: (){},child: Text(""),).padding,
                      child: Text(
                        "Generate",
                        style: TextStyle(
                            fontSize: width > 390
