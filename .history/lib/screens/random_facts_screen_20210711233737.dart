                                ...
                                text: TextSpan(
                                  children: [
                                    TextSpan(
                                        ...
                                        style: new TextStyle(
                                            color: Colors.lightBlue[900],
                                            fontSize: MediaQuery.of(context).size.height<=568?20:40,25.0,
                        ...
                        children: [
                          new IconButton(
                            ...
                            icon: Icon(
                              ...
                              size: MediaQuery.of(context).size.height<=568?20:40,
                            ),
                            onPressed: () {
                              setState(() {
                                if (_index > 0) {
                          ...
                          new MaterialButton(
                            ...
                            child: new Padding(
                              padding: EdgeInsets.symmetric(
                                  horizontal: MediaQuery.of(context).size.height<=568?40.0:60.0, vertical: 18.0),
                              child: new Text(
                                "Learn More",
                                style: new TextStyle(
