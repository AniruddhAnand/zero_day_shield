            ...
            child: Column(
              children: <Widget>[
                ...
                Row(
                  ...
                  children: [
                    CupertinoButton(
                      padding: MediaQuery.of(context).size.width<375?EdgeInsets.only(left:16,right:16):CupertinoButton(onPressed: (){},child: Text(""),).padding,
                      child: Text(
                        "Generate",
                        style: TextStyle(
                            fontSize: width > 390
                    ...
                    CupertinoButton(
                    padding: EdgeInsets.all(MediaQuery.of(context).size.width<375?16:16),
                      child: Text(
                        "  Copy  ",
                        style: TextStyle(
                            fontSize: width > 390
