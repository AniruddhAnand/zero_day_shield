                                    ...
                                    Padding(
                                      ...
                                      child: Expanded(
                                        child: RichText(
                                          ...
                                          text:TextSpan(
                                            children:[
                                              TextSpan(text:_terms[index].length>40?_terms[index].substring(0,41):_terms[index],style: TextStyle(fontSize: 30,fontWeight:FontWeight.bold,color:AppColors.headingText)),
                                              TextSpan(text:"\n\n"),
