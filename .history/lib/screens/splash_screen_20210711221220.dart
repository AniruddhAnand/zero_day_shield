...
import 'package:zero_day_shield/screens/intro_fact_screen.dart';
...
class _SplashScreenState extends State<SplashScreen>
  ...
  Route _creatSlideTransition() {
  return PageRouteBuilder(
    pageBuilder: (context, animation, secondaryAnimation) => IntroFactScreen(),
    ...
    if (_imageController.status == AnimationStatus.completed) {
      Future.delayed(Duration(milliseconds: 1000), () {
        Navigator.pushReplacement<void, void>(
            context, new MaterialPageRoute(builder: (ctx) => _creatSlideTransition()));
      });
    }
  }
