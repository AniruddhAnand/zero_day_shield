              ...
              ? new Container(
                  ...
                  child: new Column(
                    ...
                    children: <Widget>[
                      ...
                      Opacity(child: Image.asset("assets/images/app_icon_2.png",scale: MediaQuery.of(context).size.height<=667?2:1,),opacity: .65,),
                      SizedBox(
                        height:MediaQuery.of(context).size.height<=568?10:0,
                      ),
                      new MaterialButton(
                            color: Colors.lightBlue[900],
                            minWidth: 160.0,
