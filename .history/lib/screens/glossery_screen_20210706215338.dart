                ...
                itemBuilder: (context, index) => Padding(
                  ...
                  child: GestureDetector(
                                ...
                                builder: (ctx) => new ExpandedTile(
                                    Padding(
                                      ...
                                      child: RichText(
                                        ...
                                        text:TextSpan(
                                          children:[
                                            TextSpan(text:_terms[index],style: TextStyle(fontSize: 30,fontWeight:FontWeight.bold,color:AppColors.headingText)),
                                            TextSpan(text:"\n\n"),
                                            TextSpan(text:_definitions[index],style: TextStyle(fontSize: 16,color:AppColors.accentText)),
                                          ]
                                        ),
                                      ),
                                    ), null, "Term")));
                      ...
                      child: Container(
                        child: Row(
                          children: [
                            Text(_terms[index].length>40?"${_terms[index]":_terms[index]),
