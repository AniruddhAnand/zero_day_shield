                        ...
                        child: new Transform(
                            ...
                            child: Row(
                              ...
                              children: [
                                Expanded(
                                  child: new Text(
                                    _terms[_index].substring(0,_terms[_index].indexOf(". (")==-1?_terms[_index].indexOf(". "):_terms[_index].indexOf(". (")),
                                    style: new TextStyle(
                                        color: Colors.lightBlue[900],
                                        fontSize: 25.0,
                                        fontWeight: FontWeight.w300),textAlign: TextAlign.left,textDirection: TextDirection.ltr,softWrap: false,overflow: TextOverflow.ellipsis,
                                  ),
                                ),
                              ],
                            )),
