...
class _RandomFactsScreenState extends State<RandomFactsScreen> with SingleTickerProviderStateMixin {
  int _index = 0;
  List<String> _terms = [];
  void getGlos() async {
    try {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      body: new Padding(
        ...
        child: _terms.length==133?new Center(
          child: new Column(
        ...
        ):Center(child: CupertinoActivityIndicator(w),),
      ),
    );
  }
}
