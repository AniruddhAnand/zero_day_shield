...
import 'package:zero_day_shield/screens/front_screen.dart';
...
import 'package:zero_day_shield/screens/random_facts_screen.dart';
    ...
    return CupertinoTabScaffold(
      tabBar: CupertinoTabBar(
        ...
        onTap: (int index) async {
          ...
          if (index == 2) {
            current = FailedScreen("Authentication Failed");
          ...
          if (index == 5) {
            current = Scaffold(
              body:isGlos?GlosseryScreen():RandomFactsScreen(),
              ],
            );
            return;
          }
