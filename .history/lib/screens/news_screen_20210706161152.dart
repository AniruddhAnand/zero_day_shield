    ...
    try {
      ...
      client
        ...
        for (int i = 0; i < channel.items.length; i++) {
          ...
          String timeFrom =
              "${difference > 24 ? (difference + .5) ~/ 24 : difference} ${difference > 24 ? "days" : "hours"}";
        ...
        if (mounted) {
          setState(() {
            ...
            List<News> test = [News("1","","",1,""),News("0","","",0,""),News("10","","",10,""),News("5","","",5,"")];
            //_newsListings.sort((a, b) => a.hours.compareTo(b.hours));
            test.sort((a, b) => a.hours.compareTo(b.hours));
            test.forEach((item));
          });
        }
        return channel;
