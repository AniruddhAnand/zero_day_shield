                            ...
                            new MaterialPageRoute(
                                builder: (ctx) => new ExpandedTile(
                                    RichText(
                                      text:TextSpan(
                                        children:[
                                          TextSpan(text:_terms[index],style: TextStyle(fontSize: 30,fontWeight:FontWeight.bold)),
                                          TextSpan(text:_definitions[index],style: TextStyle(fontSize: 16,fontWeight:FontWeight.bold)),
                                        ]
                                      ),
                                    ), null, "Term")));
                      },
