                ...
                _currentPwd.length == 0
                    ? Text(
                        ...
                        style: TextStyle(
                            ...
                            fontSize: width>390?30:width>200?26:23,
                            color: Colors.red),
                      )
                    : RichText(
                        text: TextSpan(
                ...
                Row(
                  ...
                  children: [
                    CupertinoButton(
                      child: Text(
                        "Generate",
                        style: TextStyle(fontSize: width>390?14:width>360?12:10),
                      ),
                      color: Colors.lightBlue[900],
                      onPressed: () {
                        setState(() {
                    ...
                    CupertinoButton(
                      child: Text(
                        "  Copy  ",
                        style: TextStyle(fontSize: width>390?14:width>200?12:10),
                      ),
                      color: Colors.blue,
                      onPressed: () {
                        if (_currentPwd.length > 0) {
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                        ...
                        children: <TextSpan>[
                          TextSpan(
                            text:
                                "The general passwords you will use in your day to day life are ",
                          ),
                          TextSpan(
                            text: "NOT",
                            style:
                          ...
                          TextSpan(
                            text:
                                " secure. Most people are prone to using passwords that are related to them, such as a pet's name, or even their own name. Hackers can easily exploit this and gather information from unaware people through simple conversation with ",
                          ),
                          TextSpan(
