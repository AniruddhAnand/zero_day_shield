              ...
              ? new Container(
                  ...
                  child: new Column(
                    ...
                    children: <Widget>[
                      new Align(
                          ...
                          child: new Padding(
                            ...
                            child: new Text(
                              "Did you Know?",
                              style: new TextStyle(
                                  color: Colors.blue, fontSize:MediaQuery.of(context).size.height<=667?25.0:30.0,),
                            ),
                          )),
                      new Padding(
                                    ...
                                    children: [
                                      TextSpan(
                                          ...
                                          style: new TextStyle(
                                              ...
                                              fontSize: MediaQuery.of(context).size.height<=667?16.0:25,
                      ...
                      Opacity(child: Image.asset("assets/images/app_icon_2.png",scale: MediaQuery.of(context).size.height<=667?1.2:1,),opacity: .65,),
                      SizedBox(
                        height:MediaQuery.of(context).size.height<=667?10:0,
                      ),
                      new MaterialButton(
                            color: Colors.lightBlue[900],
                            minWidth: 160.0,
                            child: new Padding(
                              padding: MediaQuery.of(context).size.height<=667?const EdgeInsets.symmetric(
                                  horizontal: 30, vertical: 18.0):const EdgeInsets.symmetric(
