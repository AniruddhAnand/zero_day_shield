...
class _GlosseryScreenState extends State<GlosseryScreen> {
  ...
  void getGlos() async {
    try {
        var document = parse(await rootBundle.loadString('assets/data/glossery.html'));
                        ...
                        itemBuilder: (context, index) => Padding(
                          ...
                          child: GestureDetector(
                              ...
                              child: Container(
                                child: Row(
                                  children: [
                                    Text(_shown[index],style: TextStyle(fontSize: MediaQuery.of(context).size.width<375?12:14),overflow: TextOverflow.ellipsis,),
