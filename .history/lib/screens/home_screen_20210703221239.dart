...
class HomeScreen extends StatefulWidget {
  ...
  static Widget _current = HomeTabScreen();
  @override
  ...
  Widget build(BuildContext context) {
    return CupertinoTabScaffold(
      tabBar: CupertinoTabBar(
        ...
        onTap: (int index) {
          if (index == 0) {
            HomeScreen._current = HomeTabScreen();
          }
          if (index == 1) {
            HomeScreen._current = GeneratorScreen();
          }
          if (index == 2) {
           HomeScreen._current = EncryptionScreen();
          }
          if (index == 3) {
            HomeScreen._current = SecurityTestsScreen();
          }
          if (index == 4) {
            _current = NewsScreen();
          }
