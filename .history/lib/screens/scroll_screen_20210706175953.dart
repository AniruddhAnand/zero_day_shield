...
class _ScrollScreenState extends State<ScrollScreen> {
  bool isSearch  =  false;
  TextEditingController search = new TextEd
          ...
          return Dismissible(
            ...
            child: Padding(
              ...
              child: ListTile(
                ...
                title: RichText(text: TextSpan(children:getText(item.password)),softWrap: true,),
                subtitle: Row(
                  children: <Widget>[
                    Expanded(
                      child: Text(
                    ...
                    Expanded(child: Text("${item.date}",softWrap: true,style: TextStyle(color: Colors.black),))
                  ],
                ),
                trailing: IconButton(
