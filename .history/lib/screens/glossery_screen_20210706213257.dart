                        ...
                        Navigator.push(
                            ...
                            new MaterialPageRoute(
                                builder: (ctx) => new ExpandedTile(
                                    Padding(
                                      padding: const EdgeInsets.only(top:60,left: 20, right),
                                      child: RichText(
                                        text:TextSpan(
                                          children:[
                                            TextSpan(text:_terms[index],style: TextStyle(fontSize: 30,fontWeight:FontWeight.bold,color:Colors.black)),
                                            TextSpan(text:"\n\n"),
                                            TextSpan(text:_definitions[index],style: TextStyle(fontSize: 16,color:Colors.black)),
                                          ]
                                        ),
                                      ),
                                    ), null, "Term")));
