              ...
              children: [
                TextSpan(
                    ...
                    recognizer: TapGestureRecognizer()
                      ..onTap = () async {
                        await canLaunch(
                                "https://www.f5.com/labs/articles/education/what-is-the-cia-triad#:~:text=These%20three%20letters%20stand%20for,objectives%20for%20every%20security%20program.")
                            ? await launch(
                                "https://www.f5.com/labs/articles/education/what-is-the-cia-triad#:~:text=These%20three%20letters%20stand%20for,objectives%20for%20every%20security%20program.")
                            : throw 'Could not launch https://www.f5.com/labs/articles/education/what-is-the-cia-triad#:~:text=These%20three%20letters%20stand%20for,objectives%20for%20every%20security%20program.';
                      }),
              ],
            ),
          ),
          GestureDetector(
              child: Image.asset("assets/images/cia_triad.png"),
              onTap: () async {
                await canLaunch(
                        "https://www.f5.com/labs/articles/education/what-is-the-cia-triad#:~:text=These%20three%20letters%20stand%20for,objectives%20for%20every%20security%20program.")
                    ? await launch(
                    ...
                    recognizer: TapGestureRecognizer()
                      ..onTap = () async {
                        await canLaunch(
                            ...
                            ? await launch(
                                "https://en.wikipedia.org/wiki/Social_engineering_(security)")
                            : throw 'Could not launch https://en.wikipedia.org/wiki/Social_engineering_(security)';
                      }),
              ],
            ),
          ),
          ...
          Center(
            ...
            children: <Widget>[
              Container(
                ...
                child: Text("Phishing is a type of social engineering attack where an attacker sends a fraudulent message designed to trick a human victim into revealing sensitive information to the attacker or to deploy malicious software on the victim's infrastructure like ransomware.",
                    style: TextStyle(
                        fontFamily: 'BalooBhai',
                        fontSize: 20,
                        color: Colors.white)),
