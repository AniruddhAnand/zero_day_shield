          ...
          RichText(
            ...
            text: TextSpan(
              ...
              children: <TextSpan>[
                TextSpan(
                  text:
                      "Since grades to payments to taxes to retirement funds are managed online there must be a way to protect these assets. Computer security thus is the protection of systems, devices and digital assets. Computer Security knowledge allows experts to police the digital world and regular pedstrians to defend themselves.",
                )
              ],
            ),
          ),
          SizedBox(height: 20,),
          Text("The CIA triad is the foundation of computer security",style: TextStyle(fontSize: 14, color:Colors.black,fontWeight: FontWeight.bold),textAlign: TextAlign.center,),
          Image.asset("assets/images/cia_triad.png"),
        ],
      )),
  Padding(
      padding: EdgeInsets.all(20),
