      ...
      child: RichText(
        ...
        text: TextSpan(
          ...
          children: <TextSpan>[
            TextSpan(
              text:
                  "Computer security is the protection of your systems, devices and digital assets. Since grades to payments to taxes to retirement funds are managed online there must be a way to protect these assets. Computer Security knowledge allows experts ",
            )
          ],
        ),
      )),
