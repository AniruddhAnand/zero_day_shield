      ...
      child: RichText(
        ...
        text: TextSpan(
          ...
          children: <TextSpan>[
            ...
            TextSpan(
              text:
                  "to steal information from individuals. For example, social engineers may extract password information by inquiring about pets, family members etc., and may get private information about a company by masquerading as an employee. They can even steal money by pretending to be an IRS agent.",
            ),
            TextSpan(
                text: "IRS scam",
                style: TextStyle(fontWeight: FontWeight.bold),
