  ...
  Padding(
      ...
      child: Column(
        children: [
          RichText(
            ...
            text: TextSpan(
              ...
              children: <TextSpan>[
                TextSpan(
                  text:
                      "Grades to payments to taxes to retirement funds are managed online, so there must be a way to protect these assets. Computer security is the protection of systems, devices and digital assets. The CIA Triad is the foundaion for computer security.",
                )
              ],
            ),
          ),
          ...
          ExpansionCard(
            background: Image.asset("assets/images/background_3.png"),
            title: Container(
              child: Column(
            ...
            text: TextSpan(
                ...
                recognizer: TapGestureRecognizer()
                  ..onTap = () {
                    Navigator.push(
                      buildContext,
                      new MaterialPageRoute(builder:(ctx)=>new PhishingTestsScreen()),
                    );
                  }),
          ),
        ],
  ...
  Padding(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          ExpansionCard(
            background: Image.asset("assets/images/background_blue.png"),
            title: Container(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
            ...
            children: <Widget>[
              Container(
                margin: EdgeInsets.symmetric(horizontal: 7),
                child: Text(
                    "- Encryption can be as simple as substitution(Ex: a -> b)\n\n- It can also be complex such as converting to binary, pushing through xor, and tripling string",
                    style: TextStyle(
                        fontFamily: 'BalooBhai',
                        fontSize: 14,
                        color: Colors.white)),
          ...
          ExpansionCard(
            ...
            children: <Widget>[
              Container(
                margin: EdgeInsets.symmetric(horizontal: 7),
                child: Text(
                    "- Hashing is unreversible encryption\n\n- Hackers try to by pass it with rainbow tables(tables that save known hashes and the translated password) and birthday attacks(Attacks hoping to find a string with the same hash)",
                    style: TextStyle(
                        fontFamily: 'BalooBhai',
                        fontSize: 14,
                        color: Colors.white)),
