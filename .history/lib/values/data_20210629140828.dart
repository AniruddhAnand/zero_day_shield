...
many people share the same birthday, some strings will have the same hash. If a hacker can find the
birthday hash, they may crack passwords without even knowing the correct password. On the bright side, these attacks are not very feasible. \n\nOn the bright side, attempting to take hash data from a computer requires lots of searching, and finding a birthday hash could take years. This app includes a simple ",
            ),
            TextSpan(
