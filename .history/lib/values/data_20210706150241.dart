            ...
            ExpansionCard(
              ...
              children: <Widget>[
                Container(
                  margin: EdgeInsets.symmetric(horizontal: 7),
                  child: Text(
                      "- Avoid sketchy links and emails.\n\n- Change passwords regularly with 8+ characters of length, numbers, case difference, and special characters\n\n- Periodcally back up files and systems",
                      style: TextStyle(
                          fontFamily: 'BalooBhai',
                          fontSize: 14,
                          color: Colors.white)),
