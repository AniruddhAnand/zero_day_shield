          ...
          ExpansionCard(
            ...
            children: <Widget>[
              Container(
                margin: EdgeInsets.symmetric(horizontal: 7),
                child: Text(
                    "- Hashing is unreversible encryption\n\n- Hackers try to by pass it with rainbow tables(tables that save known hashes and the translated password) and birthday attacks(Attacks hoping to find a strin with the same hash)",
                    style: TextStyle(
                        fontFamily: 'BalooBhai',
                        fontSize: 14,
                        color: Colors.white)),
