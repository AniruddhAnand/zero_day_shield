          ...
          ExpansionCard(
            ...
            children: <Widget>[
              Container(
                margin: EdgeInsets.symmetric(horizontal: 7),
                child: Text(
                    "- Malware are programs designed to harm systems Common examples inclue \n\n- Keyloggers which read and save keystrokes\n\n- Viruses replicate themselves and spread increasing the damage",
                    style: TextStyle(
                        fontFamily: 'BalooBhai',
                        fontSize: 14,
                        color: Colors.white)),
