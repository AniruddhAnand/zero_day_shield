            ...
            children: <Widget>[
              Container(
                ...
                child: Text(
                    ...
                    style: TextStyle(
                        fontFamily: 'BalooBhai',
                        fontSize: MediaQuery.of(buildContext).size.height < 677
                            ? 11
                            : 14,
                        color: Colors.white)),
              )
                ...
                Container(
                  ...
                  child: Text(
                      ...
                      style: TextStyle(
                          fontFamily: 'BalooBhai',
                          fontSize:
                              MediaQuery.of(buildContext).size.height < 677
                                  ? 11
                                  : 14,
                          color: Colors.white)),
                )
