          ...
          RichText(
            ...
            text: TextSpan(
              ...
              children: <TextSpan>[
                TextSpan(
                  text:
                      "Grades to payments to taxes to retirement funds are managed online. Computer security thus is the protection of systems, devices and digital assets. Computer Security knowledge allows experts to police the digital world and regular pedstrians to defend themselves.",
                )
              ],
            ),
          ),
