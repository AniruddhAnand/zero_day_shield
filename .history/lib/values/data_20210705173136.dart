      ...
      child: Column(
        children: [
          ...
          RichText(
            text: TextSpan(
              style: TextStyle(
                ...
                children: [
                  TextSpan(
                    text:"The CIA triad is the foundation of computer security",
          ...
          GestureDetector(
              ...
              onTap: () async {
                await canLaunch("https://www.f5.com/labs/articles/education/what-is-the-cia-triad#:~:text=These%20three%20letters%20stand%20for,objectives%20for%20every%20security%20program.")
                    ? await launch(
