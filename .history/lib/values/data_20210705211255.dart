          ...
          ExpansionCard(
            ...
            children: <Widget>[
              Container(
                margin: EdgeInsets.symmetric(horizontal: 7),
                child: Text(
                    "- Malware are programs designed to harm systems.\n\n- Viruses are a type of malware that changes the code of system files to cause wreckage.\n\n\t\t- Notable malware and virusses include keyloggers, trpjan viruses, and polymorphic virus",
                    style: TextStyle(
                        fontFamily: 'BalooBhai',
                        fontSize: 14,
                        color: Colors.white)),
