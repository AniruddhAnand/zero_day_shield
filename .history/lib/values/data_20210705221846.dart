          ...
          RichText(
            ...
            text: TextSpan(
              ...
              children: <TextSpan>[
                TextSpan(
                  text:
                      "Grades to payments to taxes to retirement funds are managed online, so there must be a way to protect these assets. Computer security is the protection of systems, devices and digital assets. The CIA Triad is the foundaion ",
                )
              ],
            ),
          ),
