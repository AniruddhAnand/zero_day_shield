  ...
  Padding(
      ...
      child: Column(
        children: [
          ...
          SizedBox(height: 20,),
          Text("The CIA triad is the foundation of computer secuirty",style: TextStyle(fontSize: 14, color:Colors.black,fontWeight: FontWeight.),textAlign: TextAlign.center,),
