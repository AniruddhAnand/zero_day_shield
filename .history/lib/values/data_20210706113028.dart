          ...
          ExpansionCard(
            ...
            children: <Widget>[
              Container(
                margin: EdgeInsets.symmetric(horizontal: 7),
                child: Text(
                    "- Encryption can be as simple as substitution(Ex: a -> b)\n\n- Encryption can also be as complex as converting to binary, pushing through xor, and using mathematical formulas, and tripling the string",
                    style: TextStyle(
                        fontFamily: 'BalooBhai',
                        fontSize: 14,
                        color: Colors.white)),
            ...
            text: TextSpan(
                ...
                recognizer: TapGestureRecognizer()
                  ..onTap = () {
                    Navigator.push(
                      buildContext,
                      new MaterialPageRoute(builder:(ctx)=>new EncryptionScreen()),
                    );
                  }),
          ),
          ],
