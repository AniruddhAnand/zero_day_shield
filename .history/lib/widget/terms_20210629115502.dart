...
import 'package:zero_day_shield_app/screens/encryption_screen.dart';
...
class Terms {
  ...
  static final Widget computerSecurityTextFull = Padding(
  ...
  static final Widget threatsTextFull = Padding(
      padding: EdgeInsets.all(20),
      child: RichText(
        textAlign: TextAlign.justify,
        textDirection: TextDirection.ltr,
        ...
        text: TextSpan(
          ...
          children: <TextSpan>[
            TextSpan(
              text:
                  "Life has transitioned to the digital world, and so have criminals. They use a multitude of skills to steal information from unassuming individuals. One such technique is called social engineering. Social engineering uses trust, manipulation, impersonation, and ",
            ),
            TextSpan(
            ...
            TextSpan(
              text:
                  "to steal information from individuals. Social engineers may extract password information by inquiring the names of pets, family members etc, and may get private information about a company by masquerading as an employee. They can even steal money by pretending to be an IRS agent. Scams such as the ",
            ),
            TextSpan(
                text: "IRS scam",
                style: TextStyle(fontWeight: FontWeight.bold),
                recognizer: TapGestureRecognizer()
                  ..onTap = () async {
                    await canLaunch(
                        ...
                        ? await launch(
                            "https://en.wikipedia.org/wiki/IRS_impersonation_scam")
                        : throw 'Could not launch https://en.wikipedia.org/wiki/IRS_impersonation_scam';
                  }),
            TextSpan(
              text: " and ",
            ),
                ...
                recognizer: TapGestureRecognizer()
                  ..onTap = () async {
                    await canLaunch(
                        ...
                        ? await launch(
                            "https://www.scamwatch.gov.au/types-of-scams/unexpected-money/nigerian-scams")
                        : throw 'Could not launch https://www.scamwatch.gov.au/types-of-scams/unexpected-money/nigerian-scams';
                  }),
            TextSpan(
              text:
                  " are famous for putting gullible individuals in dangerous situations.\n\nHackers are another online threat users should be aware of. Without direct access to your device hackers cannot do much, but they can use malware to cause harm. Malware is any type of program that hopes to cause harm to a system. Malware can log keystrokes",
            ),
            TextSpan(
                text: "(Keylogger)",
                style: TextStyle(fontWeight: FontWeight.bold),
  ...
  static final Widget encryptionTextFull = Padding(
    padding: EdgeInsets.all(20),
    child:RichText(
    softWrap: true,
    textAlign: TextAlign.justify,
  ...
  static final Widget userPreventionFull = Padding(
    padding: EdgeInsets.all(20),
    child:RichText(
    textAlign: TextAlign.justify,
    textDirection: TextDirection.ltr,
    ...
    text: TextSpan(
      ...
      children: <TextSpan>[
        ...
        TextSpan(
            ...
            style: TextStyle(color: Color(0xffb63d3d)),
            recognizer: TapGestureRecognizer()
              ..onTap = () {
                Navigator.push(
                    context,
